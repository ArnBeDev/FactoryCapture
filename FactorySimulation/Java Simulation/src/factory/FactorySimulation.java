...
public class FactorySimulation {
	...
	public static boolean FASTMODE = true;// fastmode for better debugging

	
	/**
	 * Starts the simulation of the factory
	 * 
	 */
	...
	/**
	 * Here you can create customzied Factories,
	 * in this example we have 2 seperate Factory lines
	 * 
	 */
